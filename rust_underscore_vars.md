...
>
>Once you know that, you go looking in the reference and discover that it distinguishes between [Identifier Patterns](https://doc.rust-lang.org/reference/patterns.html#identifier-patterns), which introduce new variables into scope, and [Wildcard Patterns](https://doc.rust-lang.org/reference/patterns.html#wildcard-pattern), which are just the _. You might dig deeper into [Identifiers](https://doc.rust-lang.org/reference/identifiers.html#grammar-IDENTIFIER) and discover that `_` isn't even considered an identifier, but rather a [keyword](https://doc.rust-lang.org/reference/keywords.html#r-lex.keywords.strict) that kind of resembles an identifier, like `self`. 
