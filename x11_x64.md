...
A small aside about padding, [thanks to an astute reader](https://github.com/gaultier/blog/issues/6):
...
This works, but is kind of complex. If we look at this output when compiling this code, we see that `gdb` smartly optimizes this macro down to:
