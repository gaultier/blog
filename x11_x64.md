...
Tags: GUI, x86_64, X11, Optimization
---

*Discussions: [Hacker News](https://news.ycombinator.com/item?id=36153237), [r/programming](https://old.reddit.com/r/programming/comments/13xgbk6/learn_x8664_assembly_by_writing_a_gui_from_scratch/), [Lobsters](https://lobste.rs/s/dvtzfl/learn_x86_64_assembly_by_writing_gui_from).*
...
*Note: Authentication is optional in the X11 protocol, but some X11 servers e.g. XWayland require it. Authentication is skipped here and is handled in a separate [article](/blog/write_a_video_game_from_scratch_like_1987.html#authentication).*
...
%elifdef freebsd ; FreeBSD
  %define SYSCALL_EXIT 1
%elifdef darwin ; macOS 
...
This structure is only 12 bytes long, since we do not use authorization (we set all subsequent fields after the `minor_version` to 0).
