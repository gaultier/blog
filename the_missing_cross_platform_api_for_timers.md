...
- Signals are evil, do not use them, unless the OS offers a sane API to make them manageable.
- If it can be done in userspace efficiently, that's the easiest way to implement something cross-platform.
