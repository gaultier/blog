...
- *Stick all your code in a LLM and start asking it questions*: As a anti LLM person, I must admit that this idea never crossed my mind. However I think it might not be such a bad idea if you can do that in a legally safe way, ideally fully locally, and take everything with a grain a salt. I'm genuinely curious to see what answers it comes up with!
