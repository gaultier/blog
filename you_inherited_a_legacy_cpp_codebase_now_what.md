...
- *The book 'Working effectively with Legacy Code' has good advice*: I don't think I have ever read it, so thanks for the recommendation. I seem to recall I skimmed it and found it very object-oriented specific with lots of OOP design patterns, and that was not helpful to me at the time, but my memory is fuzzy.
