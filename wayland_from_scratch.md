...
We display the Wayland logo with some transparency in its own window. It's not quite Visual Studio yet, I know, but it's a good fundation for more in future articles, perhaps.
