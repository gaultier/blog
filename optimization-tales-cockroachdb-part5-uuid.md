...
And more. Essentially, if a `REGIONAL BY ROW` table as no unique constraint, apart from the primary key, which is a UUID, it is eligible for this optimization.
